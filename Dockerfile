...
LABEL org.opencontainers.image.source https://github.com/jcastellanos/demo-java-api-reactive
VOLUME /tmp
...
# Copy app
COPY --from=build /home/gradle/src/build/libs/demo-java-api-reactive.jar app.jar
